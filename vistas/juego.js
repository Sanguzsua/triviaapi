...
<head>
  ...
  <title>Trivia de todas las categorías</title>
  ...
  text-align: center;
    ...
    #preguntas-container, #favoritos-container {
      margin: 20px auto;
      max-width: 600px;
...
<body>
  ...
  <!-- Temporizador -->
  <div id="tiempo-container" style="display: none;">
  ...
  <!-- Botones -->
  <button id="btn-favoritos">⭐ Jugar Favoritos</button>
